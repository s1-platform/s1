...
public class TomcatMain {
    ...
    public static void main(String[] args) throws IOException {
        //args = new String[]{"start","localhost","9999","/test-server/core","test-server/core/webapp","9997","shutdown"};
        //args = new String[]{"stop","localhost","9997","shutdown"};
    ...
    private static void stop(String host, int stopPort, String stopKey) throws IOException {
        Socket clientSocket = new Socket(InetAddress.getByName(host), stopPort);
