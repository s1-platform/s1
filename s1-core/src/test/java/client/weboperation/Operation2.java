...
public class Operation2 extends Operation1 {
    ...
    public Map<String, Object> method2(Map<String, Object> params, HttpServletRequest request, HttpServletResponse response) throws Exception{
        return Objects.newHashMap("a","2");
    }

    @WebOperationMethod
    public Map<String, Object> method3(Map<String, Object> params, HttpServletRequest request, HttpServletResponse response) throws Exception{
        return Objects.newHashMap("a","3");
    }
}
